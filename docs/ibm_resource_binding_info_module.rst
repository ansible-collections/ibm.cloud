...
.. _ansible_collections.ibm.cloud.ibm_resource_binding_info_module:
...
ibm.cloud.ibm_resource_binding_info module -- Manage ibm\_resource\_binding info.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.ibm.cloud.ibm_resource_binding_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`ibm.cloud.ibm_resource_binding_info`.
...
- This module retrieves one or more ibm\_resource\_binding(s).
...
.. _ansible_collections.ibm.cloud.ibm_resource_binding_info_module_requirements:
