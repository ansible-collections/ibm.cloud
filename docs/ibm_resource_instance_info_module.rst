...
.. _ansible_collections.ibm.cloud.ibm_resource_instance_info_module:
...
ibm.cloud.ibm_resource_instance_info module -- Manage ibm\_resource\_instance info.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.ibm.cloud.ibm_resource_instance_info_module_requirements>` for details.

    To use it in a playbook, specify: :code:`ibm.cloud.ibm_resource_instance_info`.
...
- This module retrieves one or more ibm\_resource\_instance(s).
...
.. _ansible_collections.ibm.cloud.ibm_resource_instance_info_module_requirements:
