...
.. _ansible_collections.ibm.cloud.ibm_resource_binding_module:
...
ibm.cloud.ibm_resource_binding module -- Manage ibm\_resource\_binding resources.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    see :ref:`Requirements <ansible_collections.ibm.cloud.ibm_resource_binding_module_requirements>` for details.

    To use it in a playbook, specify: :code:`ibm.cloud.ibm_resource_binding`.
...
- This module creates, updates, or deletes a ibm\_resource\_binding.
- By default the module will look for an existing ibm\_resource\_binding.
...
.. _ansible_collections.ibm.cloud.ibm_resource_binding_module_requirements:
...
.. raw:: html
  ...
  <tr class="row-odd">
    ...
    <td><div class="ansible-option-cell">
      <p>The CRN of application to bind to in a specific environment, for example, Dallas YP, CFEE instance.</p>
    </div></td>
  </tr>
  </tbody>
  </table>
