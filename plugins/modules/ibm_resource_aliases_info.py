...
short_description: Manage C(resource_aliases) for Resource Controller.
author:
  - Kavya Handadi (@kavya498)
  - Umar Ali (@umarali-nagoor)
version_added: "1.0.0"
description:
  - This module retrieves one or more C(resource_aliases) for Resource Controller.
requirements:
...
RETURN = r'''
resources:
  description: "A list with all ResourceAlias instances."
  type: list
  elements: 'dict'
  contains:
    id:
...
try:
    ...
    from ibm_platform_services.resource_controller_v2 import ResourceAliasesForInstancePager
