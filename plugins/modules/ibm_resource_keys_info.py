...
version_added: "1.0.0"
description:
  - This module retrieves one or more C(resource_keys) for Resource Controller.
requirements:
...
RETURN = r'''
resources:
  description: "A list with all ResourceKey instances."
  type: list
  elements: 'dict'
  contains:
    id:
...
try:
    ...
    from ibm_platform_services.resource_controller_v2 import ResourceKeysPager
