...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_resource_key.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.read_patcher = patch('plugins.modules.ibm_resource_key.ResourceControllerV2.get_resource_key')
        self.read_mock = self.read_patcher.start()
        self.create_patcher = patch('plugins.modules.ibm_resource_key.ResourceControllerV2.create_resource_key')
        self.create_mock = self.create_patcher.start()
        self.update_patcher = patch('plugins.modules.ibm_resource_key.ResourceControllerV2.update_resource_key')
        self.update_mock = self.update_patcher.start()
        self.delete_patcher = patch('plugins.modules.ibm_resource_key.ResourceControllerV2.delete_resource_key')
...
class TestResourceKeyPostModule(ModuleTestCase):
    ...
    def test_create_ibm_resource_key_failed(self):
        ...
        self.read_mock.side_effect = ApiException(404)
        self.create_mock.side_effect = ApiException(400, message='Create ibm_resource_key error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Create ibm_resource_key error')
    ...
    def test_update_ibm_resource_key_failed(self):
        ...
        self.read_mock.return_value = DetailedResponseMock(resource)
        self.update_mock.side_effect = ApiException(400, message='Update ibm_resource_key error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Update ibm_resource_key error')
    ...
    def test_delete_ibm_resource_key_failed(self):
        ...
        self.read_mock.return_value = DetailedResponseMock()
        self.delete_mock.side_effect = ApiException(400, message='Delete ibm_resource_key error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Delete ibm_resource_key error')
