...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_resource_reclamations_info.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.list_patcher = patch('plugins.modules.ibm_resource_reclamations_info.ResourceControllerV2.list_reclamations')
...
class TestReclamationsListModuleInfo(ModuleTestCase):
    """
    Test class for ReclamationsList module testing.
    """
    ...
    def test_list_ibm_resource_reclamations_success(self):
        ...
        with self.assertRaises(AnsibleExitJson) as result:
            ...
            ibm_resource_reclamations_info.main()
    ...
    def test_list_ibm_resource_reclamations_failed(self):
        ...
        self.list_mock.side_effect = ApiException(400, message='List ibm_resource_reclamations error')

        with self.assertRaises(AnsibleFailJson) as result:
            os.environ['RESOURCE_CONTROLLER_AUTH_TYPE'] = 'noAuth'
            ibm_resource_reclamations_info.main()

        self.assertEqual(result.exception.args[0]['msg'], 'List ibm_resource_reclamations error')
