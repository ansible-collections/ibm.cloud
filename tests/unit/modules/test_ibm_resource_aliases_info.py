...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_resource_aliases_info.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.list_patcher = patch('plugins.modules.ibm_resource_aliases_info.ResourceAliasesForInstancePager.get_all')
...
class TestResourceAliasesListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_resource_aliases_failed(self):
        ...
        self.list_mock.side_effect = ApiException(400, message='List ibm_resource_aliases error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'List ibm_resource_aliases error')
